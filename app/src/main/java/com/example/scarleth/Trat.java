...
import com.example.scarleth.model.Modificar;
...
public class Trat extends AppCompatActivity implements View.OnClickListener {
   ...
   Residente personaSelected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trat);
        ...
        btnactuali.setOnClickListener(this);
        inicializarFirebase();
        listarDatos();
        ...
        databaseReference.child("Tratamientos").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()){
                    ...
                    listPerson.add(p);
                    arrayAdapterPersona = new ArrayAdapter<Residente>(Trat.this, android.R.layout.simple_list_item_1, listPerson);
